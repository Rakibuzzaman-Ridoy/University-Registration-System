@extends('layouts.app')
@push('title')
        <title>Payable Amount Update Form!</title>   
@endpush
                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        <div class="card-header">
                         	<h5>Payable Amount Update Form!</h5>
                        </div>
                        <!-- /.card-header -->
                        <!-- card-body -->
                        <div class="card-body">
                            <form action="{{ route('paymentAmountDataEdit',$dataupdate['0']->paymentCategory_id) }}"
                                        ...
                                        <div class="form-group col-md-5">
                                            ...
                                            <select name="paymentCategory_id" id="paymentCategory_id" class="form-control" required>
                                                ...
                                                @foreach ($paymentCategory as $pay)
                                                    <option value="{{ $pay->paymentCategory_id }}"
                                                        {{$dataupdate['0']->paymentCategory_id==$pay->paymentCategory_id?"selected":""}}>
                                                        {{ $pay->paymentCategory_name }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group col-md-5">
                                            ...
                                            <select name="department_id" id="department_id" class="form-control" required>
                                                ...
                                                @foreach ($department as $dept)
                                                    <option value="{{ $dept->department_id }}" {{$dataupdate['0']->department_id
                                                    ==$dept->department_id?"selected":""}}>{{ $dept->department_name }}</option>
                                                @endforeach
                                            </select>
                                            <span class="text-danger font-weight-bold">
                                                @error('department_id')
                                ...
                                <div class="delete_whole_extra_item_add" id="delete_whole_extra_item_add">
                                    <div class="form-row">
                                        <div class="form-group col-md-5">
                                            ...
                                            <select name="semester_id[]" id="semester_id" class="form-control" required>
                                                ...
                                                @foreach ($semester as $sem)
                                                    <option value="{{ $sem->semester_id }}" {{$update['semester_id']==$sem->semester_id?"selected":""}}>{{ $sem->semester_name }}</option>
                                                @endforeach
                                            </select>
                                            <span class="text-danger font-weight-bold">
                                                @error('semester_id[]')
                                        ...
                                        <div class="form-group col-md-5">
                                            ...
                                            <input type="text" name="amount[]" value="{{$update['amount']}}" class="form-control" placeholder="Enter Amount" required>
                                            <span class="text-danger font-weight-bold">
                                                @error('amount[]')
                                                    {{"This field is Required!"}}
                                                @enderror
